                ...
                {tab === "overview" && (
                  <div>
                    <div className="flex items-center gap-5 mb-5">
                      ...
                      <div>
                        <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-2 lg:px-8 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded capitalize">
                          {data?.specialization}
                        </span>
                        ...
                        <div className="flex items-center gap-[6px]">
                          ...
                          <span className="text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400px] text-textColor">
                            ({data?.totalRating})
                          </span>
                        </div>
