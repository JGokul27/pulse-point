    ...
    <div className='mt-10'>
        ...
        <form>
              ...
              <p className='form__label'>Email*</p>
                ...
                className="form__input" aria-readonly readOnly disabled='true' />
              </div>
              ...
              <div className='mb-5'>
                ...
                <button onClick={addQualification} className='bg-black px-5 py-2 rounded text-white h-fit'>Add Qualification</button>
              </div>
                    ...
                    <div>
                        <div className='grid grid-cols-2 md:grid-cols-4 gap-5 mb-7'>
                            <div>
                                ...
                                <select className='form__input py-4' name='day' value={item.day} onChange={e => handleTimeSlotsChange(e, index)}>
                                    <option value="">Select</option>
